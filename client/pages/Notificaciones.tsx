...
export default function Notificaciones() {
  ...
  const [notifications, setNotifications] = useState<Notification[]>([
    {
      ...
      message:
        "Ya están disponibles los resultados del sorteo del 25 de junio. Revisa tus boletos para ver si ganaste algún premio.",
    ...
    },
    {
      ...
      message:
        "El sorteo cierra hoy a las 8:00 PM. Asegúrate de comprar tus boletos antes de que termine el tiempo.",
    ...
    },
    {
      ...
      message:
        "¡Felicidades! Tu boleto #12345 ha ganado $800 USDT en el sorteo de esta semana. El premio ha sido depositado automáticamente en tu cuenta.",
    ...
    },
    {
      ...
      message:
        "Un nuevo sorteo está disponible con un premio acumulado de 45,000,000 USDT. ¡Compra tus boletos ahora!",
    ...
    },
    {
      ...
      message:
        "Tu depósito de $500 USDT ha sido acreditado exitosamente en tu cuenta. Tu nuevo saldo es $1,202.365 USDT.",
    ...
    },
    {
      ...
      message:
        "Has comprado exitosamente 2 boletos para el sorteo del 25 de agosto. Números: 08-12-19-34-45-49 y Quick Pick.",
    ...
    },
    {
      ...
      message:
        "¡Sorteo especial de fin de año! Premio doble y boletos con 50% de descuento por tiempo limitado.",
    ...
    },
    {
      ...
      message:
        "Tu solicitud de retiro de $200 USDT está siendo procesada. Recibirás los fondos en 24-48 horas.",
  ...
  const filters = [
    ...
    },
    {
      id: "draw",
      name: "Sorteos",
      count: notifications.filter((n) => n.type === "draw").length,
    },
    {
      id: "win",
      name: "Premios",
      count: notifications.filter((n) => n.type === "win").length,
    },
    {
      id: "account",
      name: "Wallet y Retiros",
