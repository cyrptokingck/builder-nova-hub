          ...
          <CardContent className="p-8 space-y-6">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">
                En LottoCoin valoramos tu privacidad y nos comprometemos a
            ...
            <div className="space-y-6">
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                  ...
                  <li>
                    Contraseña encriptada (nunca almacenamos contraseñas en
                    texto plano)
                  </li>
                  <li>
                    Dirección TRC-20 (opcional, solo si decides proporcionarla)
                  </li>
                  <li>Dirección IP para seguridad y prevención de fraudes</li>
                  <li>
                    Datos de uso de la aplicación para mejorar nuestros
                    servicios
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
                  ...
                  <li>
                    Enviarte notificaciones importantes sobre tu cuenta y
                    sorteos
                  </li>
                  <li>
                    Mostrarte tu historial de participación y transacciones
                  </li>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  compartimos información con proveedores técnicos de confianza
                  y únicamente cuando es estrictamente necesario para prestar
                  nuestros servicios (por ejemplo, procesadores de pago o
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  apropiadas, incluyendo cifrado de datos, autenticación segura
                  y mejores prácticas de la industria para proteger tu
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Podemos usar cookies y herramientas de analítica para mejorar
                  tu experiencia de usuario, detectar errores y optimizar el
                  rendimiento de la plataforma. Puedes controlar las cookies a
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  necesario para cumplir con los propósitos para los cuales fue
                  recopilada, incluyendo requisitos legales, contables o de
                  informes.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  Te notificaremos cualquier cambio importante en esta política
                  de privacidad a través de la aplicación o por correo
              ...
              <section>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  tu privacidad y datos personales, puedes contactarnos en:{" "}
                  <strong>privacidad@lottocoin.com</strong>
                </p>
              </section>
            </div>
