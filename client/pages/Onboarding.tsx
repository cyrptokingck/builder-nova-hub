  ...
  return (
    <div className="min-h-screen bg-lotto-green flex flex-col relative overflow-hidden">
      ...
      <div className="flex justify-end px-6 py-4">
        <Link to="/dashboard" className="text-lotto-black/70 font-medium">
          Skip
        </Link>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        {/* 3D Illustration - Leprechaun with gold */}
      ...
      <div className="px-6 pb-8">
        ...
        <div className="flex justify-center gap-2 mb-6">
          <div className="w-2 h-2 bg-lotto-black rounded-full"></div>
          <div className="w-6 h-2 bg-lotto-black/40 rounded-full"></div>
